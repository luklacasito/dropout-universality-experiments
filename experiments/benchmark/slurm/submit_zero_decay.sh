...
python experiments/benchmark/run_zero_decay.py plan \
...
PYTHONPATH=${PROJECT_DIR}/src python experiments/benchmark/run_zero_decay.py plan \
...
echo
python experiments/benchmark/run_zero_decay.py cost "${planner_dataset_args[@]}"
