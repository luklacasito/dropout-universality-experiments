...
PYTHONPATH=${PROJECT_DIR}/src python -m dropout_mft.experiments.benchmark zero_decay plan \
...
echo
python -m dropout_mft.experiments.benchmark zero_decay cost "${planner_dataset_args[@]}"
