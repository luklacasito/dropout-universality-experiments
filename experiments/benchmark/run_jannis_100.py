...
from dropout_mft.experiments.benchmark.workflow import (  # noqa: E402
    manifest_path,
    paired_percentile_interval as _paired_ci,
...
def command_plan(args: argparse.Namespace) -> None:
    ...
    path, provenance = write_immutable_manifest(run_dir, "confirm", specs)
...
def command_aggregate(args: argparse.Namespace) -> None:
    run_dir = Path(args.run_dir)
    specs = read_benchmark_manifest(manifest_path(run_dir, "confirm"))
