...
from dropout_mft.experiments.optiver.winning_mlp import (
    DEEP_PROFILE_IDS,
...
def test_confirmation_aggregate_requires_and_summarizes_all_profiles(tmp_path):
    ...
    command = runpy.run_path(project / "experiments/optiver/run_winning_mlp.py")[
        "command_aggregate"
    ]
...
def test_corrected_runner_evaluates_final_fold_once_at_the_end(tmp_path, monkeypatch):
    import dropout_mft.experiments.optiver.winning_mlp as winning
