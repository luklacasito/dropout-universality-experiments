...
import scripts.run_benchmark_suite as benchmark_cli
...
from dropout_mft.benchmarks import (
    BENCHMARK_NAMES,
    BENCHMARK_SPECS,
...
from scripts.prepare_benchmark_data import (
...
from dropout_mft.scale_transfer import _provenance, seed_streams
...
def test_missing_cache_names_the_preparation_command(tmp_path):
    with pytest.raises(FileNotFoundError, match="prepare_benchmark_data.py"):
