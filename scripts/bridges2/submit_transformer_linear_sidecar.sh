...
python scripts/run_transformer_linear_sidecar.py plan \
...
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_transformer_linear_sidecar.py select \
--run-dir ${RUN_DIR} && \
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_transformer_linear_sidecar.py plan \
...
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_transformer_linear_sidecar.py aggregate \
...
echo
python scripts/run_transformer_linear_sidecar.py cost
echo "Track with: squeue -u \$USER"
echo "Progress:   python scripts/run_benchmark_suite.py status --run-dir ${RUN_DIR}"
