...
python scripts/run_data_regime_sweep.py plan \
...
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_data_regime_sweep.py plan \
...
echo
python scripts/run_data_regime_sweep.py cost --regime "${REGIME}"
chain_jobs=(
