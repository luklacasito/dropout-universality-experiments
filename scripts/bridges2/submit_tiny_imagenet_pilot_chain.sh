...
python scripts/run_tiny_imagenet_pilot.py plan \
...
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_tiny_imagenet_pilot.py plan \
...
echo
python scripts/run_tiny_imagenet_pilot.py cost
