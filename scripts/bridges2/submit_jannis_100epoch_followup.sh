...
python scripts/run_jannis_100epoch_followup.py plan --run-dir "${RUN_DIR}"
...
PYTHONPATH=${PROJECT_DIR}/src python scripts/run_jannis_100epoch_followup.py aggregate \
--run-dir ${RUN_DIR}"
...
echo
python scripts/run_jannis_100epoch_followup.py cost
