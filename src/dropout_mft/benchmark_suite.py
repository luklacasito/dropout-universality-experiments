...
Like :mod:`dropout_mft.legacy_comparison`, this is a separate content-addressed
cohort rather than an extension of :class:`dropout_mft.scale_transfer.TrialSpec`.
...
from .benchmarks import BENCHMARK_SPECS, BenchmarkDataSpec, load_benchmark_bundle
from .fields import propagated_field_profile, reference_field_profile
from .models import MLPConfig, SequenceTransformer, TinyViT, build_mlp, make_optimizer
from .provenance import provenance_sha256, sha256_file
from .results import load_npz_result, save_npz_result
from .scale_transfer import _provenance, canonical_json, seed_streams
from .schedules import field_damage, schedule_layers
from .training import BenchmarkDatasetName, DatasetBundle, TrainingConfig, train_model
